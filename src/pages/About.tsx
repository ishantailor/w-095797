        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Genuine Products</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Fast Service & Support</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Custom PC Build Guidance</h3>
              <p className="text-slate-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200">
              ...
              <p className="text-xl text-slate-600">Happy Customers</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200">
              <h3 className="text-4xl font-bold text-emerald-600 mb-2">5000+</h3>
              <p className="text-xl text-slate-600">PCs Built</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200">
              <h3 className="text-4xl font-bold text-orange-600 mb-2">500+</h3>
              <p className="text-xl text-slate-600">Repairs Completed</p>
            </div>
          </div>
        </div>
      </section>
